...
FTP_PORT = 21
# UPDATED URL: Added 'www.' because Vercel 307 redirects root domain
...
def run_heartbeat():
    ...
    # Wait longer (10s) to let server settle
    time.sleep(10) 
    ...
    while True:
        try:
            ...
            # Use www. URL to avoid 307 Redirect stripping POST data
...
def main():
    ...
    # Listen on standard port 21
    server = FTPServer(("0.0.0.0", FTP_PORT), handler)
    
    # Set passive ports for better firewall compatibility (Optional dynamic range)
